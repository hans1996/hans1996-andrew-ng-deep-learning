...
print ("訓練樣本數 " + str(X_train.shape[1]))
print ("測試樣本數 " + str(X_test.shape[1]))
print ("X訓練集維度 " + str(X_train.shape))
print ("Y訓練集維度 " + str(Y_train.shape))
print ("X測試集維度 " + str(X_test.shape))
print ("Y測試集維度 " + str(Y_test.shape))
...
#        tf.summary.histogram('W3',parameters["W3"])   
...
#    
    ...
    with tf.name_scope('Accuracy'):
        ...
        tf.summary.scalar('Accuracy', ccuracy)
#        
...
#        optimizer = tf.train.AdamOptimizer(learning_rate=learning_rate,beta1=0.5,beta2=0.999).minimize(cost)

    ### END CODE HERE ###
    merged = tf.summary.merge_all()
    writer = tf.summary.FileWriter(r'C:\Users\user.LAPTOP-N880RBTF\Anaconda3\Lib\site-packages\tensorboard\log', graph = tf.get_default_graph())
